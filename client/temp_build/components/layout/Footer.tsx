      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-lg font-bold mb-4">TFW MMA Lifting Program</h2>
            <p className="text-gray-400 max-w-md">
              An 8-week progressive lifting program designed to improve strength and performance
              for mixed martial arts athletes.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/class" className="text-gray-400 hover:text-white transition-colors">
                    Current Class
                  </Link>
                </li>
              </ul>
